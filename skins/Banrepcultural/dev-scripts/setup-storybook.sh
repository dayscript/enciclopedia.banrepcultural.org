...
curl -sS "https://en.wikipedia.org/w/load.php?only=styles&skin=banrepcultural&debug=true&modules=ext.echo.styles.badge|ext.uls.pt|wikibase.client.init|mediawiki.skinning.interface" -o .storybook/integration.less
