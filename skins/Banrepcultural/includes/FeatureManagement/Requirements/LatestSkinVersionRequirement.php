...
namespace Banrepcultural\FeatureManagement\Requirements;

use Banrepcultural\Constants;
use Banrepcultural\FeatureManagement\Requirement;
use Banrepcultural\SkinVersionLookup;
 ...
 *   to the `BanrepculturalDefaultSkinVersionForNewAccounts` and
 *  `BanrepculturalDefaultSkinVersionForExistingAccounts` config values. See the `Banrepcultural\Hooks` class and
 *  `skin.json`.
 *
 ...
 *
 * - Site configuration default. The default is controlled by the `BanrepculturalDefaultSkinVersion` config
 *   value. This is used for anonymous users and as a fallback configuration. See `skin.json`.
 *
 * This majority of this class is taken from Stephen Niedzielski's `Banrepcultural\SkinVersionLookup` class,
 * which was introduced in `d1072d0fdfb1`.
 *
 * @unstable
 *
 * @package Banrepcultural\FeatureManagement\Requirements
 * @internal
 */
