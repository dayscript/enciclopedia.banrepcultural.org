...
use Banrepcultural\FeatureManagement\Requirements\LatestSkinVersionRequirement;
use Banrepcultural\SkinVersionLookup;

/**
 * @group Banrepcultural
 * @coversDefaultClass \Banrepcultural\FeatureManagement\Requirements\LatestSkinVersionRequirement
 */
class LatestSkinVersionRequirementTest extends \MediaWikiTestCase {
	...
	public function testUnmet() {
		$config = new HashConfig( [ 'BanrepculturalDefaultSkinVersionForExistingAccounts' => '1' ] );
	...
	public function testMet() {
		$config = new HashConfig( [ 'BanrepculturalDefaultSkinVersionForExistingAccounts' => '2' ] );
