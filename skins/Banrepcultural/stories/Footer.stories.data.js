	...
	},
	{
		...
		'array-items': [
			...
			},
			{
				...
				html: `<a href="//en.m.wikipedia.org/w/index.php?title=Paris&amp;useskin=banrepcultural&amp;mobileaction=toggle_view_mobile" class="noprint stopMobileRedirectToggle">Mobile view</a>`
			}
		]
	},
	{
...
export const FOOTER_TEMPLATE_DATA = {
	...
	'html-hook-banrepcultural-before-footer': placeholder( 'output of BanrepculturalBeforeFooter hook (deprecated 1.35)', 20 ),
