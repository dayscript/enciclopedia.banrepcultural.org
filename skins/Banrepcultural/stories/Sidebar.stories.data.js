...
import { banrepculturalMenuTemplate } from './MenuDropdown.stories.data';
...
export const SIDEBAR_TEMPLATE_PARTIALS = {
	Menu: banrepculturalMenuTemplate
};
...
export const SIDEBAR_DATA = {
	...
	withPortalsAndOptOut: {
		...
		'data-emphasized-sidebar-action': {
			...
			title: 'Change your settings to go back to the old look of the skin (legacy Banrepcultural)'
		},
		'array-portals-rest': [
			PORTALS.toolbox,
