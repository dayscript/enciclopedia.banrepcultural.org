/**
 * Collapsible tabs for Banrepcultural
 */
function init() {console.log('***2');
	sidebar("p-Enciclopedia-label");
	sidebar("p-Banrepcultural-label");
	sidebar("p-Colecciones-label");
	sidebar("p-Especiales-label");
	sidebar("p-Servicios-label");
	sidebar("p-Actividades-label");
	sidebar("p-Tú-label");
	...
	$tabContainer
		.on( 'beforeTabCollapse', function () {
			...
			if ( $cactions.hasClass( 'emptyPortlet' ) ) {
				$cactions.removeClass( 'emptyPortlet banrepcultural-menu-empty' );
		...
		.on( 'beforeTabExpand', function () {
			...
			if ( $cactions.find( 'li' ).length === 1 ) {
				...
				$cactions.find( 'h3' ).animate( { width: '1px' }, 'normal', function () {
					$( this ).attr( 'style', '' )
						.parent().addClass( 'emptyPortlet banrepcultural-menu-empty' );
				} );
			}
		} )
		.collapsibleTabs( {
