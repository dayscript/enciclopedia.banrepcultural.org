var collapsibleTabs = require( '../skins.banrepcultural.legacy.js/collapsibleTabs.js' ),
	banrepcultural = require( '../skins.banrepcultural.legacy.js/banrepcultural.js' ),
 ...
 * render in their terminal state on page load. By adding the `banrepcultural-animations-ready` class to the
 ...
 * // no-JS users.
 * .banrepcultural-animations-ready .foo {
...
function enableCssAnimations( document ) {
	document.documentElement.classList.add( 'banrepcultural-animations-ready' );
}
